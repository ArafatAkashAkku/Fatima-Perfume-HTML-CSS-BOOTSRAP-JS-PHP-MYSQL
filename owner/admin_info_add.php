        ...
        <main>
            <div class="d-flex flex-column align-items-center justify-content-center p-5 bg-warning">
                <div class="bg-light p-3 res-width">
                    <h2 class="text-muted text-center pt-2">Add Admin Info details</h2>
                        <form class="p-3" action="" method="POST" autocomplete="off">
                            ...
                            <div class="form-group py-2">
                                <div class="input-field">
                                    ...
                                    <input type="text" name="password" class="form-control px-3 py-2" required>
                                </div>
                            </div>
                            <div class="form-group py-2">
                                <div class="input-field">
...
if (isset($_POST['submit'])) {
    $user_exist_query = "SELECT * from `admin_info` WHERE `email`='$_POST[email]'";
  ...
  if ($result) {
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($result_fetch['email'] == $_POST['email']) {
          echo "
           <script>
           alert('$result_fetch[email] - Email already added');
          ...
          echo "
          <script>
          alert('$result_fetch[email] - Email available for adding');
          window.location.href='owner_dashboard.php';
          </script>
      ";
        }
      } else {
        $query = "INSERT INTO `admin_info`(`email`, `password`,`verified`) VALUES ('$_POST[email]','$_POST[password]','$_POST[verified]')";
